                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('header_phone_number') is-invalid @enderror"
                                           id="banner_title" name="header_phone_number" value="{{ old('title',@$common_content->header_phone_number) }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="footer_description" id="footer_description" class="form-control @error('footer_description') is-invalid @enderror">{{old('footer_description',@$common_content->footer_description)}}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('enquiry_receive_email') is-invalid @enderror"
                                           id="enquiry_receive_email" name="enquiry_receive_email" value="{{ old('enquiry_receive_email',@$common_content->enquiry_receive_email) }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('copy_right') is-invalid @enderror"
                                           id="copy_right" name="copy_right" value="{{ old('copy_right',@$common_content->copy_right) }}">
                                    @error('copy_right')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control @error('instagram_link') is-invalid @enderror"
                                           id="instagram_link" name="instagram_link" value="{{ old('instagram_link',@$common_content->instagram_link) }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('twitter_link') is-invalid @enderror"
                                           id="twitter_link" name="twitter_link" value="{{ old('twitter_link',@$common_content->twitter_link) }}">
                                    @error('twitter_link')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control @error('facebook_link') is-invalid @enderror"
                                           id="facebook_link" name="facebook_link" value="{{ old('facebook_link',@$common_content->facebook_link) }}">
                                    @error('facebook_link')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="string" class="form-control @error('linkedIn_link') is-invalid @enderror"
                                           id="linkedIn_link" name="linkedIn_link" value="{{ old('linkedIn_link',@$common_content->linkedIn_link) }}">
                                    @error('linkedIn_link')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12 image-container-div">
                                    ...
                                    <div style="display:inline-block;">
                                        <a href="javascript:void(0)"><i class="fa fa-times text-red deleteImg" data-model="SiteCommonContent" data-column="payment_image" data-id="{{$common_content->id}}"></i></a>
                                    </div>
                                @endif
                                </div>
                            </div>

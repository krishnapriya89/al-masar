...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('product-gallery.index', base64_encode($product->id)) }}">Product
            Gallery</a></li>
@endsection
@section('content')
    <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row imageDiv" @if (old('file_type') && old('file_type') != 'Image') style="display: none;" @endif>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="image_files" class="file_label">Image *</label>
                                    <div class="input-group @error('image_files') is-invalid @enderror">
                                        <input type="file" multiple accept="image/jpeg,image/png,image/webp,image/jpg"
                                            class="custom-file-input" id="image_files" name="image_files[]">
                            ...
                            <div class="col-md-12 videoDiv" @if (old('file_type') != 'Video') style="display: none;" @endif>
                                <div class="form-group">
                                    ...
                                    <div class="input-group @error('video_file') is-invalid @enderror">
                                        <input type="file" accept="video/*" class="custom-file-input file-preview"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group @error('thumb_image') is-invalid @enderror">
                                        <input type="file" accept="image/jpeg,image/png,image/webp,image/jpg"
                                            class="custom-file-input file-preview" id="thumb_image" name="thumb_image">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#image_files').on('change', function() {
                ...
                $('.image-count-holder').text(selectedImagesCount + ' files selected.');
            });

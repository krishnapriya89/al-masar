                                ...
                                <tr>
                                    <td style="padding: 0px 0 50px;">
                                        <h1
                                            ...
                                            Hi {{ $order->user ? $order->user->name : '' }}</h1>
                                        <p
                                            ...
                                            Your Order <span style="color: #E7151F; font-weight: 600; font-size: 16px;">#{{ $order->uid }}</span> status was updated to
                                            <span style="color: #E7151F; font-size: 16px; font-weight: 600; text-align: center; padding: 0 0 10px;margin: 0;">
                                                {{ $order->orderStatus->title}}
                                            </span>
                                        </p>
                                        <p style="text-align: center; margin: auto; width: 300px; font-size: 14px; font-weight: 400; color: #272525; line-height: 26px; margin-top:0px; margin-bottom: 0px;">
                                            Remark: {{ $order->admin_remarks}}
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                                                ...
                                                <tr style="margin-bottom: 8px; ">
                                                    <td style="margin: 0px; text-align: left;">
                                                        <p
                                                            ...
                                                            Tax -
                                                            <span
                                                                style="font-size: 12px;color: #000000; font-weight: 400;line-height: 22px; text-align: left;">{{ $order->tax_name }}
                                                    ...
                                                    <td style="margin: 0px; text-align: right;">
                                                        <p
                                                            style="font-size: 12px;color: #031717; font-weight: 700; margin-bottom: 0px; margin-top: 0px; line-height: 22px; text-align: right;">
                                                            {{ $order->priceWithSymbol($order->tax_amount * $order->currency_rate) }}
                                                        </p>
                                                    </td>
                                                </tr>
                                            @endif

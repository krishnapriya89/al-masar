...
@section('content')
    ...
    <!-- form start -->
    <form id="ProductCreateForm" method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
    @csrf
    <!-- /.row -->
        <div class="row">
            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="sku" name="sku" value="{{ old('sku') }}" data-model="Product"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="product_code" name="product_code" value="{{ old('product_code') }}" data-model="Product"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="model_number" name="model_number" value="{{ old('model_number') }}" data-model="Product"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="specification" name="specification"
                                              class="form-control @error('specification') is-invalid @enderror">{{ old('specification') }}</textarea>
                                    @error('specification')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="search_keywords" name="search_keywords"
                                              class="form-control @error('search_keywords') is-invalid @enderror">{{ old('search_keywords') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('min_quantity_to_buy') is-invalid @enderror"
                                           id="min_quantity_to_buy" name="min_quantity_to_buy" value="{{ old('min_quantity_to_buy') }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="other_meta_tags" name="other_meta_tags"
                                                  class="form-control @error('other_meta_tags') is-invalid @enderror">{{ old('other_meta_tags') }}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('stock_status') is-invalid @enderror"
                                    ...
                                    <option value="0" {{ old('stock_status') == '0' ? 'selected' : '' }}>Out
                                        of stock
                                    </option>
                                </select>
                                @error('stock_status')
                ...
                debounceTimer = setTimeout(function () {
                    $.ajax({
                        ...
                        beforeSend: function () {
                            ...
                            $('#ProductCreateForm').find('input, select, textarea').removeClass('is-invalid');
                    ...
                    .fail(function (response) {
                        ...
                        $.each(response.responseJSON.errors, function (field_name, error) {
                            ...
                            $("#ProductCreateForm").find('input[name="' + field_name + '"], select[name="' + field_name + '"], textarea[name="' + field_name + '"]')

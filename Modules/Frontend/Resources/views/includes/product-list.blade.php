@forelse ($products as $product)
    <tr>
            ...
            <div class="txt {{ $product->stock_class }}">
                <div class="quantity buttons_added">
                    ...
                    <input type="number" step="1" min="{{ $product->min_quantity_to_buy }}" name="quantity"
                        value="{{ $product->min_quantity_to_buy }}" title="Qty"  min="{{ $product->min_quantity_to_buy }}" class="input-text qty text change-quantity-input"
        ...
        <td>
            <div class="cart">
                <a href="javascript:void(0)" class="list-add-to-cart" data-product="{{ $product->slug }}">

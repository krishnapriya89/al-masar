                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="Vfd">
                                                <div class="icon">
                                                    <img src="{{ asset('frontend/images/vfd.svg') }}" alt="">
                                                </div>
                                                Verified
                                            </div>
                                            @error('email')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="fileUploadInput">
                                                ...
                                                <input id="attachment" name='attachment' type="file" class="fileInput" value="{{ $user->attachment }}">
                                                @error('attachment')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                                <div class="iconBx">
                                    ...
                                    @if ($user->attachment)
                                        <a href="{{ Storage::url($user->attachment) }}" target="_blank" download><i class="fa-solid fa-download">Download Attachment</i></a>
                                    @endif
                                    <div class="col-lg-12">
                                        <div class="btnBx">
                                            <button type="submit" class="save hoveranim"><span>SAVE</span></button>
                                            <button type="button" class="cancel hoveranim"><span>CANCEL</span></button>
                                        </div>
                                    </div>
                                </div>
                            </form>

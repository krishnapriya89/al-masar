                    ...
                    <div class="addressFormBx">
                        <div class="allAddress">
                            <div class="headFlx">
                                ...
                                <a href="{{route('add-billing-address')}}" class="addNew hoveranim " id="addressBtn"><span>+ Add New</span></a>
                            </div>
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active btnLink" id="home-tab" data-bs-toggle="tab"
                                        data-bs-target="#home" type="button" role="tab" aria-controls="home"
                                        aria-selected="true" data-url="{{ route('add-billing-address')}}">Billing Address</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link  btnLink" id="profile-tab" data-bs-toggle="tab"
                                        data-bs-target="#profile" type="button" role="tab" aria-controls="profile"
                                        aria-selected="false" data-url="{{ route('add-shipping-address')}}">Shipping Address</button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="savedAddBx">
                                        ...
                                        <div class="item" id="address-{{$billing_address->id}}">
                                            <div class="adresBox">
                                                <input type="radio" id="add1" class="address-{{$billing_address->id}} billing-address-radio-btn" name="address" {{ $billing_address->is_default ? 'checked' : '' }}>
                                                <label for="add1">
                                                    <div class="topBFlx">
                                                        <div class="setDefault billingAddress"  data-id="{{$billing_address->id}}" data-type="{{$billing_address->type}}">
                                                        ...
                                                        <div class="rtB">
                                                            ...
                                                            <a href="javascript:void(0)" class="dlt address-delete-btn" data-id="{{ $billing_address->id}}">
                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <div class="savedAddBx">
                                        ...
                                        <div class="item" id="address-{{$shipping_address->id}}">
                                            <div class="adresBox">
                                                <input type="radio" id="add11"  class="shippingaddress-{{$shipping_address->id}} shipping-address-radio-btn" name="address" {{ $shipping_address->is_default ? 'checked' : '' }}>
                                                <label for="add11">
                                                    <div class="topBFlx">
                                                        <div class="setDefault shippingAddress"  data-id="{{$shipping_address->id}}" data-type="{{$shipping_address->type}}">
                                                        ...
                                                        <div class="rtB">
                                                            ...
                                                            <a href="javascript:void(0)" class="dlt address-delete-btn" data-id="{{$shipping_address->id}}">
                                                                <img src="{{asset('frontend/images/delete.svg')}}" alt="">
                                                            </a>
                                                        </div>
                                                    </div>

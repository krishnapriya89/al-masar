...
<div id="pageWrapper" class="shopDetailspage InnerPage">
            ...
            <div class="MainRow">
                <div class="proSlideSecCol scrollfix">
                    <div class="proSlideSec app-figure DeskSlide" id="zoom-fig">
                        ...
                        @endif
                            ...
                            <div data-slide-id="zoom" class="zoom_gallery_slide">
                                <a id="Zoom-1" class="MagicZoom" title="" href="assets/images/pro2.png"
                                    data-zoom-image-8x="assets/images/pro2.png" data-image-8x="assets/images/pro2.png">
                                    <img src="assets/images/pro2.png" srcset="assets/images/pro2.png" alt="" />
                                </a>
                            </div>
                            <div data-slide-id="zoom" class="zoom_gallery_slide">
                                <a id="Zoom-1" class="MagicZoom" title="" href="assets/images/pro1.png"
                                    data-zoom-image-8x="assets/images/pro1.png" data-image-8x="assets/images/pro1.png">
                                    <img src="assets/images/pro1.png" srcset="assets/images/pro1.png" alt="" />
                                </a>
                            </div>
                            <div data-slide-id="video" class="zoom_gallery_slide video_slide">
                                <video src="assets/images/demo.mp4" autoplay="true" muted preload="auto"
                                    controls=""></video>
                        ...
                        <div class="slider thumbSlide">
                            <div class="item">
                                <a data-zoom-id="Zoom-1" href="assets/images/pro1.png"
                                    data-image="assets/images/pro1.png" data-zoom-image-2x="assets/images/pro1.png"
                                    data-image-2x="assets/images/pro1.png">
                                    <img srcset="assets/images/pro1.png" src="assets/images/pro1.png" />
                                </a>
                            </div>
                            <div class="item">
                                <a data-zoom-id="Zoom-1" href="assets/images/pro2.png"
                                    data-image="assets/images/pro2.png" daḍta-zoom-image-2x="assets/images/pro2.png"
                                    data-image-2x="assets/images/pro2.png">
                                    <img srcset="assets/images/pro2.png" src="assets/images/pro2.png" />
                                </a>
                            </div>
                            <div class="item">
                                <a data-zoom-id="Zoom-1" href="assets/images/pro1.png"
                            ...
                            <div class="item vidBtn">
                                <a data-zoom-id="video" href="javascript:void(0)" data-image="assets/images/pro1.png"
                                    tabindex="0">
                                    <div class="icon">
                                    ...
                                    <img class="img-fluid" srcset="assets/images/pro1.png" src="assets/images/pro1.png">
                                </a>
                            </div>
                            <div class="item">
                                <a data-zoom-id="Zoom-1" href="assets/images/pro1.png"
                    ...
                    <div class="proSlideSec MobSlide">
                        <div class="mainSlide">
                            <div class="item">
                                <a href="assets/images/pro1.png" data-fancybox="proGal">
                                    <img src="assets/images/pro1.png" data-lazy="assets/images/pro1.png" alt="pro img">
                                </a>
                            </div>
                            <div class="item">
                                <a href="assets/images/pro1.png" data-fancybox="proGal">
                ...
                <div class="ProInfoSec">
                    <div class="ProInfoSecWrp">
                        <h1 class="name">APPLE iPhone 14 (Midnight, 512 GB)</h1>
                        <div class="pcode">Product Code:<span>A2894</span></div>
                        <div class="mdlNu">Model Number:<span>A14322</span></div>
                        <div class="sku">SKU:2485798546</div>
                        <!-- <div class="colorBx">
                        ...
                        <div class="expectedP">
                            ...
                            <input type="text" name="" id="" class="form-control" placeholder="Enter Amount" required>
                        </div>
                        <div class="btnBx">
                            <a href="#!" class="quote">
                                Add to Quote
    ...
    <section id="moreInfoSec">
        <div class="container">
            ...
            <p>The iPhone 11 boasts a gorgeous all-screen Liquid Retina LCD that is water resistant up to 2 metres for
                up to 30 minutes. Moreover, the ultra-wide 13 mm lens has a 120-degree field of view for four times more
                scenes, and the 26 mm wide lens provides up to 100% Autofocus in low light.</p>
        </div>
    </section>

...
<body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <div style="margin:auto; width:600px;background: #ffffff;">
        <table id="Table_01" width="600" border="0" cellpadding="0" cellspacing="0" align="center">
            ...
            <tbody>
                <tr>
                    <td style="text-align:center;padding-top:35px; padding-bottom: 70px;">
                ...
                <tr>
                    <td style="padding: 0px 110px 0px;">
                        <table width="380" style="margin: auto; text-align: center;">
                            <tbody>
                                <tr>
                                    <td style="padding: 0px 0 100px;">
                                        <h1
                                            style="color: #E7151F; font-size: 20px; font-weight: 600; text-align: center; padding: 0 0 10px;margin: 0;">
                                          Hi {{$user->name}}</h1>
                                        <p
                                            style="text-align: center; margin: auto; font-size: 14px; font-weight: 400; color: #272525; line-height: 26px; margin-top:0px; margin-bottom: 0px;">
                                            it's greetings from Al Masar Al Saree!
                                        </p>
                                        <p
                                            style="text-align: center; margin: auto; font-size: 14px; font-weight: 400; color: #272525; line-height: 26px; margin-top:0px; margin-bottom: 0px;">
                                           Here is your Email Verification Link <a href="{{ route('user.email.verify', $token) }}">Verify</a>
                                        </p>
                                        <p style="text-align: center; font-size: 14px; font-weight: 400; color: #272525; line-height: 26px; padding-top: 15px; margin-top:0px; margin-bottom: 0px;">
                                            Email id:
                                            <a href="mailto:{{$user->email}}" style="color: #E7151F; text-decoration: none; display: inline-block; font-size: 14px; font-weight: 400;">
                                                {{$user->email}}
                                            </a>
                                        </p>
                                    </td>

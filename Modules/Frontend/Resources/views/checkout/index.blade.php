                        ...
                        <div class="lftBx">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <div class="agree">
                                        <input type="checkbox" id="billing_shipping_same" name="billing_shipping_same" value="">
                                            ...
                                            <li>
                                                <div class="rdBtn">
                                                    ...
                                                    <label for="p{{ $loop->iteration }}">
                                                        <div class="label">
                                                            <div class="icon">
                                                                <img src="{{ $payment_method->image_value }}"
                                                                    alt="cards">
                                                            </div>

                                ...
                                <tr class="quote-tr-{{ $quote->id }}">
                                    ...
                                    <td>
                                        <div class="proFlx {{ $quote->product->stock_class }}">
                                            ...
                                            <a href="{{ route('product-detail', $quote->product->slug) }}" target="_blank"
                                                class="name">{{ $quote->product->title }}</a>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="txt ">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="number" step="1" min="{{ $quote->product->min_quantity_to_buy }}"
                                                    name="quantity" value="{{ $quote->quantity }}" title="Qty"
                                                    class="input-text qty text quote-update-quantity-input quantityField" size="4" pattern="" data-quote-id="{{ $quote->id }}"
                                                    inputmode="">
                                    ...
                                    <td>
                                        ...
                                        <div class="txt">Total <span class="product-price-{{ $quote->id }} tmns">@currencySymbolWithConvertedPrice($quote->product_total_price)</span></div>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0)" class="delete quote-delete-btn" data-quote-id="{{ $quote->id }}"  data-title="{{ $quote->product->title }}">

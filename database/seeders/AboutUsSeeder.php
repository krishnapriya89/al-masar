...
class AboutUsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        AboutUs::insert([
            ...
            'banner_image'  => 'frontend/images/whoweare.jpg',
            'title'=>'A Whole Sale Distributor of Electronic Gadgets in the UAE',
            'sub_title'=>'About Us',
            'image'=>'frontend/images/about.jpg',
            ...
            'mission_bg_image'=> 'frontend/images/about.jpg',
            'mission_description'=>'lorem ipsum',
            'vision_title'=>'Vision',
            'vision_bg_image'=>'frontend/images/images.jpg',
            'vision_description'=> 'lorem ipsum',
            'values_title'=>'Values',
            'values_bg_image'=>'frontend/images/images(1).jpg',

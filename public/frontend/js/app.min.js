...
TweenLite.set("#MainMenu .MainMenuLinks li", { autoAlpha: 0, x: -110 }),
    TweenLite.set("#MainMenu .MenuBtn", { autoAlpha: 0, x: -110 })
var hamburgerMotion = new TimelineMax()
    .from("#MainMenu", 0.4, { autoAlpha: 0, x: "-100%" }, 0.2, 0.5)
    .staggerTo("#MainMenu .MainMenuLinks li", 0.2, { autoAlpha: 1, x: 0, ease: Sine.easeOut }, 0.1, 0.3)
    .to("#MainMenu .MenuBtn", 0.3, { autoAlpha: 1, x: 0 }, 1, 0.3)
    .reverse();
...
//   var btn = $(".MainMenuLinks li a");
//   // Get the menu element that shows and hides
//   var menu = $("#MainMenu");
//   // When the user clicks on the button, show or hide the menu
